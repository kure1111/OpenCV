...
void imprime_matriz(int A[3025*2][16]);
void promedio_images(int A[3025*2][16]);
Mat vec_2_img();
...
int main(int argc, char** argv){
  ...
  namedWindow( "img_Promedio_Model_1", WINDOW_NORMAL); //normal para modificar ventana a gusto
  resizeWindow( "img_Promedio_Model_1", 550, 400);
  imshow("img_Promedio_Model_1", imProm);
