...
int main(int argc, char** argv){
  ...
  namedWindow( "img_Promedio_Model_3", WINDOW_NORMAL); //normal para modificar ventana a gusto
  resizeWindow( "img_Promedio_Model_3", 550, 400);
  imshow("img_Promedio_Model_3", imProm);
